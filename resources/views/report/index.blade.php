            ...
            <div class="d-flex bg-white p-2">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" style="width: 180px">
                        @forelse ($users as $user)
                            <a href="{{ route('user.userId', $user->id) }}" class="m-3 ">{{$user->name}}</a> <br>
                        @empty
                        @endforelse
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ route('status.caseStatus', ['key' => 'जिल्ला अदालत']) }}" class="m-3">जिल्ला
                            अदालत</a><br>
                        <a href="{{ route('status.caseStatus', ['key' => 'उच्च अदालत']) }}" class="m-3">उच्च
                            अदालत</a><br>
                        <a href="{{ route('status.caseStatus', ['key' => 'सर्वोच्च अदालत']) }}" class="m-3">सर्वोच्च
                            अदालत</a><br>
                        <a href="{{ route('status.caseStatus', ['key' => 'अन्य अदालत']) }}" class="m-3">अन्य
                            अदालत</a><br>
                        <a href="{{ route('status.caseStatus', ['key' => 'स्थानीय तह']) }}" class="m-3">स्थानीय
                            तह</a><br>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ route('witness.witness', ['witness' => 'स्व नियुक्ति']) }}" class="m-3 p-2">स्व
                            नियुक्ति
                        </a><br>
                ...
                <table class="table table-hover table-borderless">
                    ...
                    <td>
                        <a class="action-btn text-success px-2"
                            href="{{ route('partydetail.index', $item) }}" data-toggle="tooltip" data-placement="bottom" title="मुद्दाको पुरा विवरण"><i class="fa fa-eye"></i></a>
                        <a class="action-btn text-primary" href="{{ route('cases.edit', $item) }}" data-toggle="tooltip" data-placement="bottom" title="Edit"><i
                        ...
                        <form action="{{ route('cases.destroy', $item) }}" method="post"
                            ...
                            @csrf
                            @method('delete')
                            <button type="submit" class="action-btn text-danger" data-toggle="tooltip" data-placement="bottom" title="Delete"><i
            ...
            <div style="width: 80vw;margin-left:10vw;margin-top:10vh">
                <div class="modal-content" style="height: 80vh;">
                    ...
                    <div style="heihtt:80vh; overflow: auto" id="my_data">
                        ...
                        <h5 class="col-12 text-center" for="" style="font-weight: normal;">मुद्दा
                            अभिलेख</h5>
