                            ...
                            <form action="{{route('partydetail.store')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input type="text" class="my-text" name="first_name" value="{{old('first_name',$cases->first_name)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>बीचको नाम</label>
                                        <input type="text" class="my-text" name="middle_name" value="{{old('middle_name',$cases->middle_name)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>थर</label>
                                        <input type="text" class="my-text" name="last_name" value="{{old('last_name',$cases->last_name)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>जन्म मिति </label>
                                        <input type="text" name="dob" id="input-fiscal-year-start"
                                            class=" nepali-date my-text" placeholder="Nepali YYYY-MM-DD" value="{{old('dob',$cases->dob)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>उमेर</label>
                                        <input type="number" class="my-text" name="age" value="{{old('age',$cases->age)}}">
                                    </div>
                                    <div class="col-lg-3 form-group" >
                                        <label>लिङ्ग</label>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input type="text" class="my-text" name="ward" value="{{old('ward',$cases->ward)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>सम्पर्क नम्बर </label>
                                        <input type="text" class="my-text" name="contact" value="{{old('contact',$cases->contact)}}">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>इमेल</label>
