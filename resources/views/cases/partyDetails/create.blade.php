        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="card z-depth-0">
                    <div class="card-body">
                        <div class="my-4">
                            <form action="{{$partyDetail->id? route('partydetail.update',$partyDetail):route('partydetail.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    @else
                                        <input type="hidden" name="cases_id" value="{{ $partyDetail->id }}">
                                    @endisset
                                    <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="gender" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->gender}}" selected>{{$partyDetail->gender}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="marrige_status" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                                <option value="{{$partyDetail->marrige_status}}" selected>{{$partyDetail->marrige_status}}</option>
                                            @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="district" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->district}}" selected>{{$partyDetail->district}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="municipality" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->municipality}}" selected>{{$partyDetail->municipality}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="cast" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->cast}}" selected>{{$partyDetail->cast}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="religion" id="" class="my-text">
                                            ...
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->religion}}" selected>{{$partyDetail->religion}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <select name="education" id="" class="my-text">
                                            <option value="" disabled selected>कृपया जाति चयन गर्नुहोस्</option>
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->education}}" selected>{{$partyDetail->education}}</option>
                                        @endisset
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <select name="disability_status" id="" class="my-text">
                                            <option value="" disabled selected>कृपया जाति चयन गर्नुहोस्</option>
                                            @isset($partyDetail->id)
                                            <option value="{{$partyDetail->disability_status}}" selected>{{$partyDetail->disability_status}}</option>
                                        @endisset
