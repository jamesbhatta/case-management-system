...
@section('caseContent')
    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        <div class="bg-light mt-3">
            <label class="h3 font-weight-bold mt-3 mx-4">प्रहरी कार्यालय</label>
            (<b>मुद्दा नम्बर</b>: {{ $cases->case_number }})
            (<b>मुद्दा प्रकार</b>: {{ $cases->case_type }})
            (<b>मुद्दा स्थिति</b>: {{ $cases->case_status }})
            <a href="{{ route('police-station.create', $cases) }}" class="btn btn-info float-right mx-5">Add</a>
        </div>
                    ...
                    @foreach ($consultations as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="action-btn text-primary" href="{{ route('police-station.edit', $item) }}"><i
                                        class="far fa-edit"></i></a>
                                <form action="{{ route('police-station.destroy', $item) }}" method="post"
