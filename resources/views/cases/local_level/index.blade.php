...
<div class="card z-depth-0">
    <div class="card-body">
        ...
        <div class="my-4">
            <form action="{{ $consultation->id ? route('local-level.update', $consultation) : route('local-level.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="hidden" class="form-control p-4" name="type" value="localLevel">
                    </div>
                    @endisset
