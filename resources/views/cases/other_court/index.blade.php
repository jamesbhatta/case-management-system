...
@section('caseContent')
    <div class="card z-depth-0">
        <div class="card-body">
            <label for="" class="h3 col-12 p-3 font-weight-bold border-bottom">अन्य अदालत</label>
            <div class="my-4">
                <form
                    action="{{ $consultation->id ? route('other-court.update', $consultation) : route('other-court.store') }}"
