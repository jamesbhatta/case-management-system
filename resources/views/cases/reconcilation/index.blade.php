...
@section('caseContent')
    <div class="card z-depth-0">
        <div class="card-body">
            <label for="" class="h3 col-12 p-3 font-weight-bold border-bottom">मेलमिलाप</label>
            <div class="my-4">
                <form
                    action="{{ $consultation->id ? route('reconcilation.update', $consultation) : route('reconcilation.store') }}"
                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-lg-4 form-group">
                                ...
                                <input type="hidden" class="form-control p-4" name="type" value="melmilap">
                            </div>
                        @endisset
