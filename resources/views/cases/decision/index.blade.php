...
<div class="card z-depth-0">
    <div class="card-body">
        <div class="bg-light mt-3">
            <label class="h3 font-weight-bold mt-3 mx-4">निर्णय भइसकेको</label>
            (<b>मुद्दा नम्बर</b>: {{ $cases->case_number }})
            (<b>मुद्दा प्रकार</b>: {{ $cases->case_type }})
            (<b>मुद्दा स्थिति</b>: {{ $cases->case_status }})
        </div>
        <div class="my-4">
            <form action="{{ $consultation->id ? route('decision.update', $consultation) : route('decision.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="hidden" class="form-control p-4" name="type" value="decision">
                    </div>
                    @endisset
