                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="marrige_status" id="" class="form-control"style="height:50px">
                            ...
                            <option value="सम्बन्ध बिछेदी" @if (old('marrige_status')=="सम्बन्ध बिछेदी")selected @endif>सम्बन्ध बिछेदी</option>
                            <option value="एकल" @if (old('marrige_status')=="एकल")selected @endif>एकल</option>
                            <option value="संगै बसेको" @if (old('marrige_status')=="संगै बसेको")selected @endif>संगै बसेको</option>
                        </select>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        <label>*जिल्ला </label>
                        <select name="district" id="" class="form-control" style="height:50px">
                            ...
                            @foreach ($districts as $item)
                                <option value="{{ $item->name }}" @if (old('district')==$item->name)selected @endif>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="municipality" id="" class="form-control" style="height:50px">
                            ...
                            @foreach ($municipalities as $item)
                                <option value="{{ $item->name }}" @if (old('municipality')==$item->name)selected @endif>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="cast" id="" class="form-control" style="height:50px">
                            ...
                            @endisset
                            <option value="खस आर्य" @if (old('cast')=="खस आर्य")selected @endif>खस आर्य</option>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="religion" id="" class="form-control" style="height:50px">
                            ...
                            <option value="मुसलमान" @if (old('religion')=="मुसलमान")selected @endif>मुसलमान</option>
                            <option value="क्रिस्चियन" @if (old('religion')=="क्रिस्चियन")selected @endif>क्रिस्चियन</option>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="education" id="" class="form-control" style="height:50px">
                            ...
                            @endisset
                            <option value="असाक्षर"@if (old('education')=="र्निरक्षर")selected @endif>र्निरक्षर</option>
                            <option value="साक्षर"@if (old('education')=="साक्षर")selected @endif>साक्षर</option>
                            <option value="माध्यमिक तह "@if (old('education')=="माध्यमिक तह")selected @endif>माध्यमिक तह </option>
                            <option value="एस.एल.सी"@if (old('education')=="एस.एल.सी")selected @endif>एस.एल.सी</option>
                            <option value="Intermediate"@if (old('education')=="Intermediate")selected @endif>Intermediate</option>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 form-group">
                        ...
                        <select name="disability_status" id="" class="form-control"
                            ...
                            @endisset
                            <option value="शारिरिक अपाङ्गता"  @if (old('disability_status')=="शारिरिक अपाङ्गता")selected @endif>शारिरिक अपाङ्गता</option>
                            <option value="दृष्टि सम्बन्धी अपाङ्गता" @if (old('disability_status')=="दृष्टि सम्बन्धी अपाङ्गता")selected @endif>दृष्टि सम्बन्धी अपाङ्गता</option>
