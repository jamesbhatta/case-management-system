...
<div class="card z-depth-0">
    <div class="card-body">
        ...
        <div class="bg-light mt-3">
            <label class="h3 font-weight-bold mt-3 mx-4">बहस</label>
            (<b>मुद्दा नम्बर</b>: {{ $cases->case_number }})
            (<b>मुद्दा प्रकार</b>: {{ $cases->case_type }})
            (<b>मुद्दा स्थिति</b>: {{ $cases->case_status }})
        </div>
        <div class="my-4">
            <form action="{{ $consultation->id ? route('debate.update', $consultation) : route('debate.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
