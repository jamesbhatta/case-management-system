...
@section('caseContent')
    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        <div class="bg-light mt-3">
            ...
            <a href="{{ route('facilation.create', $cases) }}" class="btn btn-info float-right mx-5">Add</a>
        </div>
                    ...
                    @foreach ($consultations as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="action-btn text-primary" href="{{ route('facilation.edit', $item) }}"><i
                                        class="far fa-edit"></i></a>
                                <form action="{{ route('facilation.destroy', $item) }}" method="post"
