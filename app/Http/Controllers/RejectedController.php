...
class RejectedController extends Controller
{
    ...
    public function create(Cases $cases, Consultation $consultation)
    {
        ...
        return view('cases.rejected.index', compact(['cases', 'consultation']));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rejected.index', $cases)->with('success', "Added");
    }
    ...
    public function update(Request $request, Consultation $consultation)
    {
        ...
        return redirect()->route('rejected.index', $cases)->with('success', "Updated");
    }
