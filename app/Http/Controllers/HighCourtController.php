...
class HighCourtController extends Controller
{
    ...
    public function create(Cases $cases, Consultation $consultation)
    {
        ...
        return view('cases.high_court.index', compact(['cases', 'consultation']));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($case_status=='सर्वोच्च अदालत' || $case_status=='अन्य अदालत'  || $case_status=='निर्णय भइसकेको' || $case_status=='अस्वीकार गरिएको'){
            
        }else{
            $current_case->update([
                'case_status'=>'उच्च अदालत'
            ]);
        }
    ...
    public function update(Request $request, Consultation $consultation)
    {
        ...
        return redirect()->route('high-court.index', $cases)->with('success', "Updated");
    }
