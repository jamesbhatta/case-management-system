...
class CasesController extends Controller
{
    public function index(Cases $cases)
    {
        ...
        $allCases = Cases::with(['partyDetail', 'oppositParty', 'informToParty', 'caseType'])
            ->latest()
            ->paginate(50);
    ...
    public function store(Request $request)
    {
        ...
        //
        return redirect()
            ->route('partydetail.index', $case_id->id)
            ->with('success', 'मुद्दा सफलतापूर्वक दर्ता भयो');
    }
    ...
    public function destroy(Cases $cases)
    {
        ...
        return redirect()
            ->back()
            ->with('success', 'मुद्दा सफलतापूर्वक हटाइयो');
    }
    ...
    public function edit(Cases $cases)
    {
        ...
        $allCases = Cases::all();
        return view('cases.index', compact(['allCases', 'cases','users']));
    }
